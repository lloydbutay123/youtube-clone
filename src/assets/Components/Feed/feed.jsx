...
const feed = ({ category }) => {
  ...
  const fetchData = async () => {
    const videoList_url = `https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics%20&chart=mostPopular&maxResults=50&regionCode=PH&videoCategoryId=${category}&key=${API_KEY}`;
