    ...
    <div className="md:flex p-2 md:px-28">
      <div className="md:pr-5 md:w-2/3">
        <iframe
          ...
          className="rounded-2xl w-full md:h-[360px]"
        ></iframe>
        <div>
        ...
        <div className="flex flex-wrap justify-between w-full my-3 space-y-2  ">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button className="flex py-2 px-2 bg-gray-200 rounded-full">
              <FaShare size={25} />
              Share
            </button>
